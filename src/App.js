...
function App() {
    ...
    const [userName, setUserName] = React.useState('Matt');
    ...
    const Todo = ({ todo, index }) => (
      <tr>
          ...
          <td>
              <button className="btn btn-secondary" onClick = {() => removeTodo(index)}>Delete</button>
          </td>
      </tr>
    );
    ...
    <div className="App">
        ...
        <div className="col-12">
            <input className="form-control mb-2" value={newTodo} onChange={updateValue}/>
            <button class="auto-size" onClick={newTodoItem} className="btn btn-primary mb-2">Add</button>
        </div>
